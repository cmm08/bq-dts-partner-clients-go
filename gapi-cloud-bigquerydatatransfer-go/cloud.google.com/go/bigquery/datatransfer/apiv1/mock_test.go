...
func TestDataSourceServiceCreateDataSourceDefinition(t *testing.T) {
	...
	var serviceAccount string = "serviceAccount-1948028253"
	var disabled bool = true
	var transferConfigPubsubTopic string = "transferConfigPubsubTopic71465884"
	var expectedResponse = &datatransferpb.DataSourceDefinition{
		...
		Disabled:                  disabled,
		TransferConfigPubsubTopic: transferConfigPubsubTopic,
	}
...
func TestDataTransferServiceStartManualTransferRuns(t *testing.T) {
	...
	var formattedParent string = fmt.Sprintf("projects/%s/locations/%s/transferConfigs/%s", "[PROJECT]", "[LOCATION]", "[TRANSFER_CONFIG]")
	var request = &datatransferpb.StartManualTransferRunsRequest{
		Parent: formattedParent,
	}
